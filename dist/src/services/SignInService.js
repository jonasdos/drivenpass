...
function loginService(loginData) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userRepository_1.default.getUserByEmail(loginData.email)];
                case 1:
                    user = _a.sent();
                    if (!user) {
                        throw {
                ...
                case 2:
                    match = _a.sent();
                    if (match) {
                        token = jsonwebtoken_1.default.sign({ user: user }, process.env.SECRET, { expiresIn: 3000 });
